...
| `refine approval draft --review-request <file>` | Role-agnostic approval draft flow for `training`, `kernel`, and `lean`; verifies role evidence and writes `approvals/<role>.draft.json` without creating final approval |
