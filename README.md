...
| [docs/ecosystem.md](docs/ecosystem.md) | The 4-project map (Cogn8ty + HELYX+NAL + Knowledge-Foundry + refineforge); strict-NARS observation (Cogn8ty is symbolic; HELYX-NAL is differentiable); pair-by-pair complementarity matrix; honest "complementary ≠ integrated" constraint; one-liner: **"Cogn8ty thinks, HELYX runs, KF teaches, refineforge proves. Rust binds them."** |
